...
class __TwigTemplate_03d11b1dcc7fdd1bc5b38054fc5b2a0c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_empty_categories_listing($context, array $blocks = [])
    {
        ...
        // line 34
        echo "    ";
        $this->loadTemplate("@PrestaShop/Admin/Sell/Catalog/Monitoring/index.html.twig", "@PrestaShop/Admin/Sell/Catalog/Monitoring/index.html.twig", 34, "1289481395")->display(twig_array_merge($context, ["grid" => (isset($context["emptyCategoryGrid"]) || array_key_exists("emptyCategoryGrid", $context) ? $context["emptyCategoryGrid"] : (function () { throw new RuntimeError('Variable "emptyCategoryGrid" does not exist.', 34, $this->source); })())]));
        // line 55
        echo "  ";
...
/* @PrestaShop/Admin/Sell/Catalog/Monitoring/index.html.twig */
class __TwigTemplate_03d11b1dcc7fdd1bc5b38054fc5b2a0c___1289481395 extends Template
{
    private $source;
    private $macros = [];
